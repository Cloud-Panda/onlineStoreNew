...
<body>
  <nav class="navbar navbar-expand-md nav-back navbar-dark">
    <!-- Brand -->
    <a class="navbar-brand" href="shopping.php">Saint's</a>
        ...
        <div class="table-responsive mt-2">
          <table class="table table-striped text-center">
            <thead>
              <tr>
                <td colspan="7">
                  <h4 class="text-center text-info product-title m-0">Products in your cart!</h4>
                </td>
              </tr>
              <tr>
                <th>ID</th>
                ...
                <th>Total Price</th>
                <th>
                  <a href="action.php?clear=all" class="badge-danger badge p-1 clear-cart"
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                 R<?= number_format($row['product_price'],2); ?>
                </td>
                ...
                <td>
                  <a href="action.php?remove=<?= $row['id'] ?>" class="text-danger lead"
                    onclick="return confirm('Are you sure want to remove this item?');"><i class="fas fa-trash"></i></a>
                </td>
              </tr>
              ...
              <tr>
                <td colspan="3">
                  <a href="shopping.php" class="btn btn-success"><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;Continue
                    Shopping</a>
                </td>
